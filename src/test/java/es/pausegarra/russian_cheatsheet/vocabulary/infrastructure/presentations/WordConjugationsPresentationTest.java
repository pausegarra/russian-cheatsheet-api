...
class WordConjugationsPresentationTest {
  ...
  public void shouldMapFromDto() {
    ...
    assertEquals(
      ...
      presentation.imperfectivePresentFirstPersonSingular()
    );
    assertEquals(
      dto.imperfectivePresentSecondPersonSingular(),
      presentation.imperfectivePresentSecondPersonSingular()
    );
    assertEquals(
      dto.imperfectivePresentThirdPersonSingular(),
      presentation.imperfectivePresentThirdPersonSingular()
    );
    assertEquals(
      dto.imperfectivePresentFirstPersonPlural(),
      presentation.imperfectivePresentFirstPersonPlural()
    );
    assertEquals(
      dto.imperfectivePresentSecondPersonPlural(),
      presentation.imperfectivePresentSecondPersonPlural()
    );
    assertEquals(
      dto.imperfectivePresentThirdPersonPlural(),
      presentation.imperfectivePresentThirdPersonPlural()
    );
    ...
    assertEquals(
      ...
      presentation.imperfectiveFutureFirstPersonSingular()
    );
    assertEquals(
      dto.imperfectiveFutureSecondPersonSingular(),
      presentation.imperfectiveFutureSecondPersonSingular()
    );
    assertEquals(
      dto.imperfectiveFutureThirdPersonSingular(),
      presentation.imperfectiveFutureThirdPersonSingular()
    );
    assertEquals(
      dto.imperfectiveFutureFirstPersonPlural(),
      presentation.imperfectiveFutureFirstPersonPlural()
    );
    assertEquals(
      dto.imperfectiveFutureSecondPersonPlural(),
      presentation.imperfectiveFutureSecondPersonPlural()
    );
    assertEquals(
      dto.imperfectiveFutureThirdPersonPlural(),
      presentation.imperfectiveFutureThirdPersonPlural()
    );

    assertEquals(
      dto.perfectivePresentFirstPersonSingular(),
      presentation.perfectivePresentFirstPersonSingular()
    );
    assertEquals(
      dto.perfectivePresentSecondPersonSingular(),
      presentation.perfectivePresentSecondPersonSingular()
    );
    assertEquals(
      dto.perfectivePresentThirdPersonSingular(),
      presentation.perfectivePresentThirdPersonSingular()
    );
    assertEquals(
      dto.perfectivePresentFirstPersonPlural(),
      presentation.perfectivePresentFirstPersonPlural()
    );
    assertEquals(
      dto.perfectivePresentSecondPersonPlural(),
      presentation.perfectivePresentSecondPersonPlural()
    );
    assertEquals(
      dto.perfectivePresentThirdPersonPlural(),
      presentation.perfectivePresentThirdPersonPlural()
    );
    ...
    assertEquals(
      ...
      presentation.perfectiveFutureFirstPersonSingular()
    );
    assertEquals(
      dto.perfectiveFutureSecondPersonSingular(),
      presentation.perfectiveFutureSecondPersonSingular()
    );
    assertEquals(
      dto.perfectiveFutureThirdPersonSingular(),
      presentation.perfectiveFutureThirdPersonSingular()
    );
    assertEquals(
      dto.perfectiveFutureFirstPersonPlural(),
      presentation.perfectiveFutureFirstPersonPlural()
    );
    assertEquals(
      dto.perfectiveFutureSecondPersonPlural(),
      presentation.perfectiveFutureSecondPersonPlural()
    );
    assertEquals(
      dto.perfectiveFutureThirdPersonPlural(),
      presentation.perfectiveFutureThirdPersonPlural()
    );
  }
