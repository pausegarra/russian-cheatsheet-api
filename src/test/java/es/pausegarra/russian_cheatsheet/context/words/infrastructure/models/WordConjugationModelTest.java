...
class WordConjugationModelTest {
  ...
  public void shouldMapFromEntity() {
    ...
    WordConjugationModel wordConjugationModel = WordConjugationModel.fromEntity(
      wordConjugationEntity,
      WordModel.fromEntity(wordConjugationEntity.word())
    );

    assertNotNull(wordConjugationModel);
    assertEquals(wordConjugationEntity.id(), wordConjugationModel.getId());
    assertEquals(
      wordConjugationEntity.imperfectivePresentFirstPersonSingular(),
      wordConjugationModel.getImperfectivePresentFirstPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentSecondPersonSingular(),
      wordConjugationModel.getImperfectivePresentSecondPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentThirdPersonSingular(),
      wordConjugationModel.getImperfectivePresentThirdPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentFirstPersonPlural(),
      wordConjugationModel.getImperfectivePresentFirstPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentSecondPersonPlural(),
      wordConjugationModel.getImperfectivePresentSecondPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentThirdPersonPlural(),
      wordConjugationModel.getImperfectivePresentThirdPersonPlural()
    );
    ...
    assertEquals(
      wordConjugationEntity.imperfectiveFutureFirstPersonSingular(),
      wordConjugationModel.getImperfectiveFutureFirstPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureSecondPersonSingular(),
      wordConjugationModel.getImperfectiveFutureSecondPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureThirdPersonSingular(),
      wordConjugationModel.getImperfectiveFutureThirdPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureFirstPersonPlural(),
      wordConjugationModel.getImperfectiveFutureFirstPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureSecondPersonPlural(),
      wordConjugationModel.getImperfectiveFutureSecondPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureThirdPersonPlural(),
      wordConjugationModel.getImperfectiveFutureThirdPersonPlural()
    );
    ...
    assertEquals(
      wordConjugationEntity.perfectiveFutureFirstPersonSingular(),
      wordConjugationModel.getPerfectiveFutureFirstPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.perfectiveFutureSecondPersonSingular(),
      wordConjugationModel.getPerfectiveFutureSecondPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.perfectiveFutureThirdPersonSingular(),
      wordConjugationModel.getPerfectiveFutureThirdPersonSingular()
    );
  ...
  public void shouldMapToEntity() {
    ...
    assertEquals(
      wordConjugationEntity.imperfectivePresentFirstPersonSingular(),
      wordConjugationEntityFromModel.imperfectivePresentFirstPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentSecondPersonSingular(),
      wordConjugationEntityFromModel.imperfectivePresentSecondPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentThirdPersonSingular(),
      wordConjugationEntityFromModel.imperfectivePresentThirdPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentFirstPersonPlural(),
      wordConjugationEntityFromModel.imperfectivePresentFirstPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentSecondPersonPlural(),
      wordConjugationEntityFromModel.imperfectivePresentSecondPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectivePresentThirdPersonPlural(),
      wordConjugationEntityFromModel.imperfectivePresentThirdPersonPlural()
    );
    ...
    assertEquals(
      wordConjugationEntity.imperfectiveFutureFirstPersonSingular(),
      wordConjugationEntityFromModel.imperfectiveFutureFirstPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureSecondPersonSingular(),
      wordConjugationEntityFromModel.imperfectiveFutureSecondPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureThirdPersonSingular(),
      wordConjugationEntityFromModel.imperfectiveFutureThirdPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureFirstPersonPlural(),
      wordConjugationEntityFromModel.imperfectiveFutureFirstPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureSecondPersonPlural(),
      wordConjugationEntityFromModel.imperfectiveFutureSecondPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.imperfectiveFutureThirdPersonPlural(),
      wordConjugationEntityFromModel.imperfectiveFutureThirdPersonPlural()
    );
    ...
    assertEquals(
      wordConjugationEntity.perfectiveFutureFirstPersonSingular(),
      wordConjugationEntityFromModel.perfectiveFutureFirstPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.perfectiveFutureSecondPersonSingular(),
      wordConjugationEntityFromModel.perfectiveFutureSecondPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.perfectiveFutureThirdPersonSingular(),
      wordConjugationEntityFromModel.perfectiveFutureThirdPersonSingular()
    );
    assertEquals(
      wordConjugationEntity.perfectiveFutureFirstPersonPlural(),
      wordConjugationEntityFromModel.perfectiveFutureFirstPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.perfectiveFutureSecondPersonPlural(),
      wordConjugationEntityFromModel.perfectiveFutureSecondPersonPlural()
    );
    assertEquals(
      wordConjugationEntity.perfectiveFutureThirdPersonPlural(),
      wordConjugationEntityFromModel.perfectiveFutureThirdPersonPlural()
    );
