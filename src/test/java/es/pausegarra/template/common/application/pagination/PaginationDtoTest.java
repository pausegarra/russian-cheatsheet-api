package es.pausegarra.template.common.application.pagination;

import es.pausegarra.template.common.application.pagination.PaginatedDto;
import es.pausegarra.template.common.domain.pagination_and_sorting.Paginated;
