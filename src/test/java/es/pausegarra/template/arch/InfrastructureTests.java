...
public class InfrastructureTests extends BaseArchTest {
  ...
  @ArchTest
  static final ArchRule infrastructure_classes_should_not_be_accessed_from_application_or_domain
    = classes().that()
  ...
  @ArchTest
  static final ArchRule repository_implementations_should_reside_in_infrastructure_package =
    classes().that()
    .areNotInterfaces()
    .and()
