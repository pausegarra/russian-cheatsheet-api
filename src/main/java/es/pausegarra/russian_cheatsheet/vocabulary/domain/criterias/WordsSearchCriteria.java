...
public class WordsSearchCriteria extends Criteria {
  ...
  private WordsSearchCriteria(int page, int pageSize, String sortBy, String sortDirection, String search) {
    super(new Page(page, pageSize), new Sort(sortBy, SortDirection.valueOf(sortDirection.toUpperCase())));
    this.search = search;
  }

  public static WordsSearchCriteria create(int page, int pageSize, String sortBy, String sortDirection, String search) {
