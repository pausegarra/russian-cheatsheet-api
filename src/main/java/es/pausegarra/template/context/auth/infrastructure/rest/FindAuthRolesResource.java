package es.pausegarra.template.context.auth.infrastructure.rest;

import es.pausegarra.template.context.auth.application.dto.PermissionsDto;
import es.pausegarra.template.context.auth.application.servies.find_aiuth_roles.FindAuthRolesDto;
import es.pausegarra.template.context.auth.infrastructure.config.KeycloakConfig;
import es.pausegarra.template.common.application.interfaces.Service;
import es.pausegarra.template.context.auth.infrastructure.spec.FindAuthRolesApiSpec;
