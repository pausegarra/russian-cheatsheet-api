package es.pausegarra.template.auth.infrastructure.security.interceptors;
...
import es.pausegarra.template.auth.infrastructure.security.annotations.HasPermission;
